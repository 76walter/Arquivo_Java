...
public class GerenciaFuncionarios {
    private static final String FILE_PATH = "C:\\Users\\walter\\Documentos\\ArquivoJava\\arquivocsv\\questao19\\funcionarios.dat";

    public static void main(String[] args) throws IOException {
        RandomAccessFile file = new RandomAccessFile(FILE_PATH, "rw");

        Funcionario funcionario = new Funcionario(1, "walter", 9000.0);
