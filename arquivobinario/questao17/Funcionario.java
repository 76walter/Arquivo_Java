...
public class GerenciaFuncionarios {
    private static final String FILE_PATH = "C:\\Users\\walter\\Documentos\\ArquivoJava\\arquivobinario\\questao17\\funcionarios.dat";

    public static void main(String[] args) throws IOException {
        RandomAccessFile file = new RandomAccessFile(FILE_PATH, "rw");

        Funcionario funcionario = new Funcionario(1, "sophia", 9000.0);
