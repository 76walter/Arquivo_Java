...
public class RemoveLinhas {
    ...
    public static void main(String[] args) {
        try {
            ...
            File arquivoEntrada = new File("C:\\Users\\walter\\Documentos\\ArquivoJava\\arquivotexto\\questao08\\meuarquivo.txt");
            BufferedReader leitor = new BufferedReader(new FileReader(arquivoEntrada));

            File arquivoSaida = new File("C:\\Users\\walter\\Documentos\\ArquivoJava\\arquivotexto\\questao08\\meuarquivo_sem_excluir.txt");
